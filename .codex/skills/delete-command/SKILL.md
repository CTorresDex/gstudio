...
3. **deterministic** — Run .gstudio/artifacts/command/scripts/delete/step-3.sh <command-path> where <command-path> is the slash-separated command path (e.g. create/artifact) to search the codebase for references to.

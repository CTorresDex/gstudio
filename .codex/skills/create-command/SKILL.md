...
2. **deterministic** — Run .gstudio/artifacts/command/scripts/create/step-2.sh <path> where <path> is the slash-separated command path (e.g. create/artifact), written exactly as it appears in the file location.

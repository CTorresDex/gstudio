...
description: Checks that a command file has exactly the required help and default-export structure and delegates all logic to classes, given the command path as input.
---

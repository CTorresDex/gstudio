---
name: list-artifact
description: Lists artifact definitions in the codebase, optionally filtered by a search term, and prints each match as its artifact name and file path.
---
...
2. **deterministic** — Run .gstudio/artifacts/artifact/scripts/list/step-2.sh [search-term] to list every artifact whose name or definition file path contains the optional search term, or all artifacts if omitted.
